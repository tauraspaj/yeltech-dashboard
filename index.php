...
<div class="flex-auto bg-gray-100 flex p-4 lg:p-8">
	...
	<div class="flex-auto grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8 auto-rows-min">
		...
		<div class="col-span-1 card-wrapper-1 h-36">
		...
		<!-- Card wrapper -->
		<div class="col-span-1 h-36 flex flex-col bg-white border border-gray-300 shadow-md">
			<!-- Card header -->
			<div class="flex-none flex items-center h-10 bg-gray-100 border-b border-gray-300">
				<div class="hidden sm:block absolute p-2 mx-2 xl:mx-4 text-gray-500">
				...
				<div class="font-bold text-xs uppercase text-gray-700 mx-auto bg-blue-100 font-spacemono tracking-wide">
					Total users
				</div>
			</div>
			<!-- Card body -->
		...
		?>
		<div class="col-span-1 card-wrapper-1 h-36 <?php echo $borderHighlight;?>">
			<div class="card-header-1">
				<div class="card-icon-1">
			...
			<div class="card-body-1 flex-col">
		...
		<div class="col-span-2 card-wrapper-1">
			<div class="card-header-1 text-red-900">
				...
				<div class="card-title-1 bg-red-100 text-red-900">
					Alarmed devices
				</div>
			</div>
		...
		<div class="col-span-2 card-wrapper-1">
			...
			<div class="card-body-1 h-96 p-2">
				<div id="homeMap" class="w-full h-full rounded"></div>
			</div>
		</div>
