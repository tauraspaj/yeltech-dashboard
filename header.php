				...
				<div class="flex-auto flex flex-col justify-between border-r border-gray-300 py-4">
					...
					<div class="flex flex-col">
						...
						forEach ($pages as $page) {
							echo '
							<a href="'.$page['url'].'" class="flex flex-col justify-center items-center my-4 space-y-2 '.(($page['url'] == $activeUrl)?'text-yellow-primary':'text-gray-400 hover:text-gray-800').'" title="'.$page['title'].'">
								'.$page['icon'].'
        ...
        <div class="flex-auto flex flex-col">
            ...
            <div class="sticky top-0 flex-none flex justify-between h-16 bg-gray-50 border-b border-gray-300 z-20">
				<div class="flex flex-auto max-w-xl">
					...
					<button id="burger_desktop" class="hidden lg:flex flex-none h-16 w-16 items-center justify-center border-r border-gray-300 hover:bg-yellow-primary group hover:border-yellow-primary focus:outline-none">
					...
					<button id="burger_mobile" class="flex lg:hidden flex-none h-16 w-16 items-center justify-center border-r border-l hover:bg-primary group hover:border-primary focus:outline-none">
						<svg class="w-5 h-5 text-gray-700 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M4 6h16M4 12h16M4 18h16"></path></svg>
						<svg class="w-3 h-3 text-yellow-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"></path></svg>
					</button>
				...
				<div class="flex">
					<!-- Notification icon -->
					<button id="notificationsButton" class="flex-none h-16 w-16 md:w-20 flex items-center justify-center text-gray-700 hover:text-white border-l border-r border-gray-300 hover:bg-yellow-primary hover:border-yellow-primary focus:outline-none focus:text-white focus:bg-yellow-primary focus:border-yellow-primary">
						...
						if ($devicesCount == 0) {
							...
							for ($i = 0; $i < $devicesCount; $i++) {
								...
								echo '
								<a href="./device.php?id='.$triggeredDevices[$i]['deviceId'].'" class="flex justify-between items-center text-lightblue-500 hover:bg-gray-100 hover:text-lightblue-600 cursor-pointer space-x-3 py-4 px-2 border-t">
					...
					<!-- Profile -->
					<button id="openProfile" class="flex-none h-16 w-16 sm:w-auto flex items-center justify-center text-gray-700 hover:text-white border-r border-gray-300 hover:bg-yellow-primary hover:border-yellow-primary focus:outline-none px-4">
					...
					<a href="includes/logout.inc.php" class="">
						<button class="flex-none h-16 w-12 md:w-20 flex items-center justify-center text-gray-700 hover:text-white hover:bg-yellow-primary focus:outline-none focus:bg-yellow-primary">
