        ...
        success: function (data) {
            ...
            if (devices.length > 0) {
                for (i = 0; i < devices.length; i++) {
                    ...
                    output += `                    
                    <!-- Alarm -->
                    <a href="./device.php?id=`+devices[i].deviceId+`" class="flex flex-none h-12 text-sm text-gray-700 font-medium items-center pl-2 border border-red-500 rounded bg-gray-100 cursor-pointer hover:bg-gray-200" title="View device">
